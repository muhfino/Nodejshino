...
module.exports = function (app) {
   ...
   app.route('/hmsi/board/api/crudconfig')
    ...
    app.route('/hmsi/board/api/allholiday/:companycode')
        .get(jsonku.holidaycompanycode);
        
    app.route('/hmsi/board/api/scheduller_sparepart')
        .get(jsonku.scheduller_sparepart);
        
    app.route('/hmsi/board/api/spektrumku')
        .post(jsonku.spektrumku);

    app.route('/hmsi/board/api/scheduller_sparepart_manual')
        .post(jsonku.scheduller_sparepart_manual);
}